...
if args.finetuning_mode == "standard":
    save_file = f"{args.save}/negations_{args.control_dataset}.json"
elif args.finetuning_mode == "linear":
    save_file = f"{args.save}/linear_negations_{args.control_dataset}.json"
elif args.finetuning_mode == "posthoc":
    save_file = f"{args.save}/posthoc_negations_{args.control_dataset}.json"
